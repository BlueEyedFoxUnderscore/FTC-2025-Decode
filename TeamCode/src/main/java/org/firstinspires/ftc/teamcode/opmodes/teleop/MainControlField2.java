...
public class MainControlField2 extends OpMode {
...
//        gate.setPosition(gamepad1.right_trigger);
    ...
    private static final int[] KNOWN_TARGET_SPEEDS =    {2370, 2360, 2290, 2440, 2620, 2760, 2910, 3060, 3160-50, 3300-100, 3500-100};
