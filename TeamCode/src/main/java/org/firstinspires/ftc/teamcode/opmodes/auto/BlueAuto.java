...
public class BlueAuto {
    ...
    public static void init(Follower follower, PathAuto auto) {
        ...
        final Pose PGP_APPROACH_CONTROL_POINT_POSE = new Pose(144-85.0212765957447, 60-1);
        final Pose PGP_ROW_HEAD_POSE = new Pose(144-94, 60-1).withHeading(Math.toRadians(180-0));
        final Pose PGP_ROW_TAIL_POSE = new Pose(144-121.547 + 8, 60-1).withHeading(Math.toRadians(180-0));
        final Pose PGP_ROW_EXIT_POSE = new Pose(144-106, 60-1).withHeading(Math.toRadians(180-0));
        final Pose PGP_ROW_EXIT_CONTROL_POINT = new Pose(144- 71, 72-1);
        ...
        COLLECT_PPG_ROW = follower.pathBuilder()
                ...
                .addPath(new BezierLine(PPG_ROW_HEAD_POSE, PPG_ROW_TAIL_POSE))
                    ...
                    .addParametricCallback(0.9, () -> auto.setFollowerMaxPower(0.2))
