...
public class BlueAutoUnsorted {
    ...
    public static void init(Follower follower, PathAuto auto) {
        ...
        final Pose READ_OBELISK_POSE = new Pose(144-101, 115).withHeading(Math.toRadians(180-135));

        final Pose PRE_SHOOTING_POSE = new Pose(144-99.5, 106.5).withHeading(Math.toRadians(180-45));
        ...
        final Pose PPG_ROW_TAIL_POSE = new Pose(144-121 - 5.5, 84).withHeading(Math.toRadians(180-0));
        //                                                  /|\  row end (5.5 at speed 2)

        final Pose LEVER = new Pose(144-129.35593220338984, 69.21065375302663).withHeading(toRadians(180-90));
        final Pose LEVER_CONTROL = new Pose(144-89.95641646489103, 73.39467312348668);


        final Pose PGP_APPROACH_CONTROL_POINT_POSE = new Pose(144-85.0212765957447, 60-1.5);
        final Pose PGP_ROW_HEAD_POSE = new Pose(144-94, 60-1.5).withHeading(Math.toRadians(180-0));
        final Pose PGP_ROW_TAIL_POSE = new Pose(144-121.547 - 12, 60-1.5).withHeading(Math.toRadians(180-0));
        //                                                       /|\ row end (12 at speed .2)
        final Pose PGP_ROW_EXIT_POSE = new Pose(144-106, 60-1.5).withHeading(Math.toRadians(180-0));
        final Pose PGP_ROW_EXIT_CONTROL_POINT = new Pose(144- 71, 72-1.5);
        ...
        final Pose GPP_ROW_TAIL_POSE = new Pose(144-121.210 - 12, 36).withHeading(Math.toRadians(180-0));
        //                                                       /|\ row end (12 at speed .2)
